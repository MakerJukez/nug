export default function App() {
  return (
    <div className="bg-slate-300">
      <div className="w-full max-w-[840px] mx-auto px-4 py-8 sm:px-6 lg:px-8 bg-slate-300">
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className="w-28 h-28 sm:w-40 sm:h-40 rounded-full bg-gray-200 flex items-center justify-center">
            <img src="/nug.png" alt="User" className="w-full h-full rounded-full object-cover ring-2 ring-[#ff8c00]" />
          ...
          <div className="text-center">
            ...
            <div className="text-gray-800">
              <div className='flex justify-center items-center z-10'>
                <a href="https://x.com/nugonsolana" className=''>
                ...
                <a href="https://t.me/nugonsolana" className=''>
          ...
          <div className="flex items-center space-x-6 text-white">
            <div className="flex flex-col items-center">
              <span className="text-xl font-bold text-black">69</span>
              <span className="text-gray-800 text-sm">Posts</span>
            </div>
            <div className="h-8 border-l border-gray-300"></div>
            <div className="flex flex-col items-center">
              <span className="text-xl font-bold text-black">420K</span>
              <span className="text-gray-800 text-sm">Followers</span>
            </div>
            <div className="h-8 border-l border-gray-300"></div>
            <div className="flex flex-col items-center">
              <span className="text-xl font-bold text-black">0</span>
              <span className="text-gray-800 text-sm">Following</span>
            </div>
          </div>
        </div>
